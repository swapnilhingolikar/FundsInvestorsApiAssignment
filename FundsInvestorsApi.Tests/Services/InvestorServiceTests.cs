...
namespace FundsInvestorsApi.Tests.Services
{
    public class InvestorServiceTests
    {
        ...
        public async Task GetAllAsync_ShouldReturnMappedInvestorDtos()
        {
            ...
            var investorDtos = new List<InvestorDto>
            {
                new InvestorDto
                {
                    ...
                    FullName = investors[0].FullName,
                    Email = investors[0].Email,
                    FundId = investors[0].FundId
                }
            };
        ...
        {
            // Arrange
            var createDto = new InvestorCreateDto
            {
        ...
        {
            // Arrange
            var updateDto = new InvestorUpdateDto
            {
                InvestorId = Guid.NewGuid(),
                FullName = "Bob Green",
            ...
            var investor = new Investor
            {
                InvestorId = updateDto.InvestorId,
                FullName = updateDto.FullName,
                Email = updateDto.Email,
                FundId = updateDto.FundId
            };
